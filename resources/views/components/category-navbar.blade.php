    ...
    <div class="row justify-content-evenly">
        ...
        <div class="col-5 col-md-1 category-nav-link d-flex flex-column justify-content-center p-3 my-1">
            <a href="{{route('categoryShow',[6])}}" class="d-flex flex-column align-items-center decoration-none">
                <p class="text-black">{{__('ui.music')}}</p>
                <i class="fa-solid fa-music fa-xl text-black"></i> 
            </a>
        </div>
        <div class="col-5 col-md-1 category-nav-link d-flex flex-column justify-content-center p-3 my-1">
            <a href="{{route('categoryShow',[7])}}" class="d-flex flex-column align-items-center decoration-none">
                <p class="text-black">{{__('ui.fashion')}}</p>
                <i class="fa-solid fa-shirt fa-xl text-black"></i> 
            </a>
        </div>
        <div class="col-5 col-md-1 category-nav-link d-flex flex-column justify-content-center p-3 my-1">
            <a href="{{route('categoryShow',[8])}}" class="d-flex flex-column align-items-center decoration-none">
                <p class="text-black">{{__('ui.gardening')}}</p>
                <i class="fa-solid fa-trowel fa-xl text-black"></i>
            </a>
        </div>
        <div class="col-5 col-md-1 category-nav-link d-flex flex-column justify-content-center p-3 my-1">
            <a href="{{route('categoryShow',[9])}}" class="d-flex flex-column align-items-center decoration-none">
                <p class="text-black">{{__('ui.accessories')}}</p>
                <i class="fa-solid fa-screwdriver-wrench fa-xl text-black"></i>
            </a>
        </div>
        <div class="col-5 col-md-1 category-nav-link d-flex flex-column justify-content-center p-3 my-1">
            <a href="{{route('categoryShow',[10])}}" class="d-flex flex-column align-items-center decoration-none">
                <p class="text-black">{{__('ui.animals')}}</p>
                <i class="fa-solid fa-dog fa-xl text-black"></i> 
            </a>
        </div>
    </div>
</div>
